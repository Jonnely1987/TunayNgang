      ...
      >
        ...
        >
          ...
          <ul class="flex flex-col lg:flex-row list-none lg:ml-auto">
            ...
            <li class="flex items-center">
              <button
                class="bg-pink-200 text-gray-800 active:bg-gray-100 text-xs font-bold uppercase px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none lg:mr-1 lg:mb-0 ml-3 mb-3"
          ...
          <div class="items-center flex flex-wrap">
            <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
              <div class="pr-12">
                ...
                "TunayNgang: Your Gateway to Endless Opportunities"
                </h1>
...
<?php /**PATH C:\Users\jonne\TunayNgang\resources\views/landing.blade.php ENDPATH**/ ?>